...
for train_index, test_index in skf.split(X, y):
    ...
    model.save(os.path.join(MODEL_DIR, DATASET_NAME + '_' + CLASSIFIER_TYPE + '_' + str(GROUP_TYPE) + '_' + str(kFold_index)))
    np.save(os.path.join(MODEL_HISTORY_DIR, DATASET_NAME + '_' + CLASSIFIER_TYPE + '_' + str(GROUP_TYPE) + '_' + str(kFold_index) + ".npy"), history.history)
    
    print(bcolors.OKBLUE + "Saving test data" + bcolors.ENDC)
    X_test_val_name = CLASSIFIER_TYPE + str(GROUP_TYPE) + '_' + str(kFold_index) + '_X_test.pkl'
    y_test_val_name = CLASSIFIER_TYPE + str(GROUP_TYPE) + '_' + str(kFold_index) + '_y_test.pkl'
